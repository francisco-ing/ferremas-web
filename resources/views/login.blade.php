...
@include('header')
<section class="bg-gray-000 dark:bg-gray-0">
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Aun sin cuenta? <a href="register" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Crear </a>
                  </p>
              </form>
          </div>
      </div>
