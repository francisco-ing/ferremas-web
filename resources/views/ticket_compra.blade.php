...
<body>
    ...
    <div class="container">
        <div class="card">
            <h3 class="text-2xl font-bold text-gray-700 mb-4">Orden</h3>
            <ul class="divide-y">
                <li class="flex items-center justify-between py-3">
                    <span>Subtotal</span>
                    <span class="font-bold">${{ session('totalPrice') * 0.81 }}</span>
                </li>
                <li class="flex items-center justify-between py-3">
                    <span>Impuestos</span>
                    <span class="font-bold">${{ session('totalPrice') * 0.19 }}</span>
                </li>
