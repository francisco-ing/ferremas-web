          ...
          <div class="flex items-start justify-between gap-4 py-8">
              <div class="flex gap-6">
                <div class="h-64 bg-gray-100 p-6 rounded">
                  <img src='https://baumart.cl/wp-content/uploads/2024/02/martillo-inoxcrom.webp' class="w-full h-full object-contain shrink-0" />
                </div>
                <div>
                  <p class="text-md font-bold text-[#333]">Martillo lindo</p>
                  <p class="text-gray-400 text-xs mt-1">1 Item</p>
                  <h4 class="text-xl font-bold text-[#333] mt-4">$20.000</h4>
                  <div class="mt-6">
